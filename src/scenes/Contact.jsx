  ...
  return (
    <section id="contact" className="contact py-48">
      ...
      <div className="md:flex md:justify-between gap-16 mt-1">
        ...
        >
          <img src="../assets/touch.jpg" alt="contact bg-black" />
        </motion.div>
        ...
        >
          ...
          >
            <input
              className="w-full bg-[#1da1aa] font-semibold placeholder-opaque-black p-3"
              type="text"
              placeholder="NAME"
              {...register("name", {
                required: true,
            ...
            <input
              className="w-full bg-[#1da1aa] font-semibold placeholder-opaque-black p-3 mt-5"
              type="text"
              placeholder="EMAIL"
              {...register("email", {
                required: true,
